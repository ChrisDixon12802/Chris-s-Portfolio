it took me a while to build a portfolio but it was a fun experince to build the one thing i couldnt figure out was how to get the pictures to load which was very
...
<html lang="en">
  ...
  <p class="goal">
        ...
        <img src="https://via.placeholder.com/300x200" alt="Project preview" />
  </section>
  ...
  <section class="projects">
   ...
   <footer class="footer">
      ...
      <p>&copy; 2025 Chris's Portfolio All Rights Reserved</p>
    </footer>
  </body>
</html>
